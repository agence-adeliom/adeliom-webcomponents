...
describe('<awc-alert>', () => {
  ...
  it('renders', async () => {
    const alert = await fixture<SlAlert>(html`<awc-alert open>I am an alert</awc-alert>`);
  ...
  describe('alert visibility', () => {
    ...
    it('should not be visible without the open attribute', async () => {
      const alert = await fixture<SlAlert>(html` <awc-alert>I am an alert</awc-alert>`);
  ...
  describe('close button', () => {
    it('shows a close button if the alert has the closable attribute', () => async () => {
      const alert = await fixture<SlAlert>(html` <awc-alert open closable>I am an alert</awc-alert> `);
  ...
  describe('toast', () => {
    ...
    it('resolves only after being closed', async () => {
      const alert = await fixture<SlAlert>(html`<awc-alert closable>I am an alert</awc-alert>`);
  ...
  describe('timer controlled closing', () => {
    it('closes after a predefined amount of time', async () => {
      ...
      const alert = await fixture<SlAlert>(html` <awc-alert open duration="3000">I am an alert</awc-alert>`);
    ...
    it('resets the closing timer after opening', async () => {
      clock = sinon.useFakeTimers();
      const alert = await fixture<SlAlert>(html` <awc-alert duration="3000">I am an alert</awc-alert>`);
  ...
  describe('alert variants', () => {
    ...
    variants.forEach(variant => {
      it(`adapts to the variant: ${variant}`, async () => {
        const alert = await fixture<SlAlert>(html`<awc-alert variant="${variant}" open>I am an alert</awc-alert>`);
