 ...
 */
export default class AWCRadioGroup extends ShoelaceElement implements ShoelaceFormControl {
  ...
  private getAllRadios() {
    return [...this.querySelectorAll<SlRadio | AWCRadioButton>('awc-radio, awc-radio-button')];
  }

  private handleRadioClick(event: MouseEvent) {
    const target = (event.target as HTMLElement).closest<SlRadio | AWCRadioButton>('awc-radio, awc-radio-button')!;
