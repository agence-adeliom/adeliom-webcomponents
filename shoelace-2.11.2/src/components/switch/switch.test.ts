...
describe('<awc-switch>', () => {
  it('should pass accessibility tests', async () => {
    const el = await fixture<SlSwitch>(html` <awc-switch>Switch</awc-switch> `);
    await expect(el).to.be.accessible();
  });

  it('default properties', async () => {
    const el = await fixture<SlSwitch>(html` <awc-switch></awc-switch> `);
  ...
  it('should have title if title attribute is set', async () => {
    const el = await fixture<SlSwitch>(html` <awc-switch title="Test"></awc-switch> `);
  ...
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<SlSwitch>(html` <awc-switch disabled></awc-switch> `);
  ...
  it('should emit awc-change and awc-input when toggled with the left arrow', async () => {
    const el = await fixture<SlSwitch>(html` <awc-switch checked></awc-switch> `);
    const changeHandler = sinon.spy();
    const inputHandler = sinon.spy();
  ...
  describe('when submitting a form', () => {
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      ...
      const slSwitch = el.querySelector<SlSwitch>('awc-switch')!;
  ...
  it('should not jump the page to the bottom when focusing a switch at the bottom of an element with overflow: auto;', async () => {
    ...
    const switches = el.querySelectorAll<SlSwitch>('awc-switch');
