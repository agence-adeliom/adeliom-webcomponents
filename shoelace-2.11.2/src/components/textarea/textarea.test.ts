...
describe('<awc-textarea>', () => {
  it('should pass accessibility tests', async () => {
    const el = await fixture<SlTextarea>(html` <awc-textarea label="Name"></awc-textarea> `);
    await expect(el).to.be.accessible();
  });

  it('default properties', async () => {
    const el = await fixture<SlTextarea>(html` <awc-textarea></awc-textarea> `);
  ...
  it('should have title if title attribute is set', async () => {
    const el = await fixture<SlTextarea>(html` <awc-textarea title="Test"></awc-textarea> `);
  ...
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<SlTextarea>(html` <awc-textarea disabled></awc-textarea> `);
  ...
  describe('when the value changes', () => {
    ...
    it('should not emit awc-change or awc-input when calling setRangeText()', async () => {
      const el = await fixture<SlTextarea>(html` <awc-textarea value="hi there"></awc-textarea> `);
  ...
  describe('when using constraint validation', () => {
    ...
    it('should be invalid when required and empty', async () => {
      const el = await fixture<SlTextarea>(html` <awc-textarea required></awc-textarea> `);

      expect(el.checkValidity()).to.be.false;
    });

    it('should be invalid when required and after removing disabled ', async () => {
      const el = await fixture<SlTextarea>(html` <awc-textarea disabled required></awc-textarea> `);
    ...
    it('should receive the correct validation attributes ("states") when valid', async () => {
      const el = await fixture<SlTextarea>(html` <awc-textarea required value="a"></awc-textarea> `);
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      ...
      const textarea = el.querySelector<SlTextarea>('awc-textarea')!;
  ...
  describe('when submitting a form', () => {
    it('should serialize its name and value with FormData', async () => {
      const form = await fixture<HTMLFormElement>(html` <form><awc-textarea name="a" value="1"></awc-textarea></form> `);
  ...
  describe('when using spellcheck', () => {
    ...
    it('should enable spellcheck when set to "true"', async () => {
      const el = await fixture<SlTextarea>(html` <awc-textarea spellcheck="true"></awc-textarea> `);
      const textarea = el.shadowRoot!.querySelector<HTMLTextAreaElement>('textarea')!;
      expect(textarea.getAttribute('spellcheck')).to.equal('true');
      expect(textarea.spellcheck).to.be.true;
    });
    ...
    it('should disable spellcheck when set to "false"', async () => {
      const el = await fixture<SlTextarea>(html` <awc-textarea spellcheck="false"></awc-textarea> `);
      const textarea = el.shadowRoot!.querySelector<HTMLTextAreaElement>('textarea')!;
