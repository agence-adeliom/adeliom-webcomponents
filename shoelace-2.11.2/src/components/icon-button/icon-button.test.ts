...
describe('<awc-icon-button>', () => {
  describe('defaults ', () => {
    it('default properties', async () => {
      const el = await fixture<SlIconButton>(html` <awc-icon-button></awc-icon-button> `);
  ...
  describe('when icon attributes are present', () => {
    it('renders an awc-icon from a library', async () => {
      const el = await fixture<SlIconButton>(html` <awc-icon-button library="system" name="check"></awc-icon-button> `);
  ...
  describe('when href is present', () => {
    it('renders as an anchor', async () => {
      const el = await fixture<SlIconButton>(html` <awc-icon-button href="some/path"></awc-icon-button> `);
  ...
  describe('when label is present', () => {
    it('the internal aria-label attribute is set to the provided label when rendering a button', async () => {
      ...
      const el = await fixture<SlIconButton>(html` <awc-icon-button label="${fakeLabel}"></awc-icon-button> `);
  ...
  describe('when disabled is present', () => {
    it('the internal button has a disabled attribute when rendering a button', async () => {
      const el = await fixture<SlIconButton>(html` <awc-icon-button disabled></awc-icon-button> `);
      expect(el.shadowRoot?.querySelector(`button[disabled]`)).to.exist;
    });

    it('the internal anchor has an aria-disabled attribute when rendering an anchor', async () => {
      const el = await fixture<SlIconButton>(html` <awc-icon-button href="some/path" disabled></awc-icon-button> `);
