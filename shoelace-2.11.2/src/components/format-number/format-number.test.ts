...
describe('<awc-format-number>', () => {
  describe('defaults ', () => {
    it('default properties', async () => {
      const el = await fixture<SlFormatNumber>(html` <awc-format-number></awc-format-number> `);
  ...
  describe('noGrouping property', () => {
    it(`number has correct grouping format: no grouping`, async () => {
      const el = await fixture<SlFormatNumber>(html` <awc-format-number value="1000" no-grouping></awc-format-number> `);
    ...
    it(`number has correct grouping format: grouping`, async () => {
      const el = await fixture<SlFormatNumber>(html` <awc-format-number value="1000"></awc-format-number> `);
