...
describe('<awc-icon>', () => {
  ...
  describe('defaults ', () => {
    it('default properties', async () => {
      const el = await fixture<SlIcon>(html` <awc-icon></awc-icon> `);
    ...
    it('renders pre-loaded system icons and emits awc-load event', async () => {
      const el = await fixture<SlIcon>(html` <awc-icon library="system"></awc-icon> `);
      const listener = oneEvent(el, 'awc-load') as Promise<SlLoadEvent>;
    ...
    it('the icon is accessible', async () => {
      const el = await fixture<SlIcon>(html` <awc-icon library="system" name="check"></awc-icon> `);
  ...
  describe('when a label is provided', () => {
    it('the icon has the correct default aria attributes', async () => {
      ...
      const el = await fixture<SlIcon>(html` <awc-icon label="${fakeLabel}" library="system" name="check"></awc-icon> `);
  ...
  describe('new library', () => {
    it('renders icons from the new library and emits awc-load event', async () => {
      const el = await fixture<SlIcon>(html` <awc-icon library="test-library"></awc-icon> `);
      const listener = oneEvent(el, 'awc-load') as Promise<SlLoadEvent>;
    ...
    it('runs mutator from new library', async () => {
      const el = await fixture<SlIcon>(html` <awc-icon library="test-library" name="test-icon1"></awc-icon> `);
      await elementUpdated(el);
  ...
  describe('negative cases', () => {
    ...
    it("svg not rendered with an icon that doesn't exist in the library", async () => {
      const el = await fixture<SlIcon>(html` <awc-icon library="test-library" name="does-not-exist"></awc-icon> `);
    ...
    it('emits awc-error when the file cant be retrieved', async () => {
      const el = await fixture<SlIcon>(html` <awc-icon library="test-library"></awc-icon> `);
      const listener = oneEvent(el, 'awc-error') as Promise<SlErrorEvent>;
  ...
  describe('svg sprite sheets', () => {
    ...
    it('Should properly grab an SVG and render it from bootstrap icons', async () => {
      ...
      const el = await fixture<SlIcon>(html`<awc-icon name="arrow-left" library="sprite"></awc-icon>`);
    ...
    it('Should render nothing if the sprite hash is wrong', async () => {
      ...
      const el = await fixture<SlIcon>(html`<awc-icon name="non-existent" library="sprite"></awc-icon>`);
    ...
    it.skip("Should produce an error if the icon doesn't exist.", async () => {
      ...
      const el = await fixture<SlIcon>(html`<awc-icon name="bad-icon" library="sprite"></awc-icon>`);
      const listener = oneEvent(el, 'awc-error') as Promise<SlErrorEvent>;
