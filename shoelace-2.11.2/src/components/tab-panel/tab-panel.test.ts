...
describe('<awc-tab-panel>', () => {
  it('passes accessibility test', async () => {
    const el = await fixture<SlTabPanel>(html` <awc-tab-panel>Test</awc-tab-panel> `);
  ...
  it('passed id should be used', async () => {
    const el = await fixture<SlTabPanel>(html` <awc-tab-panel id="test-id">Test</awc-tab-panel> `);
