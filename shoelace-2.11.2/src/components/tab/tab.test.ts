...
describe('<awc-tab>', () => {
  ...
  it('should render default tab', async () => {
    const el = await fixture<SlTab>(html` <awc-tab>Test</awc-tab> `);
  ...
  it('should disable tab by attribute', async () => {
    const el = await fixture<SlTab>(html` <awc-tab disabled>Test</awc-tab> `);
  ...
  it('should set active tab by attribute', async () => {
    const el = await fixture<SlTab>(html` <awc-tab active>Test</awc-tab> `);
  ...
  it('should set closable by attribute', async () => {
    const el = await fixture<SlTab>(html` <awc-tab closable>Test</awc-tab> `);
