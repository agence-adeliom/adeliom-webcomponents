...
describe('<awc-menu-item>', () => {
  ...
  it('should have the correct default properties', async () => {
    const el = await fixture<SlMenuItem>(html` <awc-menu-item>Test</awc-menu-item> `);
  ...
  it('should render the correct aria attributes when disabled', async () => {
    const el = await fixture<SlMenuItem>(html` <awc-menu-item disabled>Test</awc-menu-item> `);
  ...
  it('should emit the slotchange event when the label changes', async () => {
    const el = await fixture<SlMenuItem>(html` <awc-menu-item>Text</awc-menu-item> `);
