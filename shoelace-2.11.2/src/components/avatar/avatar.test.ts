...
describe('<awc-avatar>', () => {
  ...
  describe('when provided no parameters', () => {
    before(async () => {
      el = await fixture<SlAvatar>(html` <awc-avatar label="Avatar"></awc-avatar> `);
    });
  ...
  describe('when provided an image and label parameter', () => {
    ...
    before(async () => {
      el = await fixture<SlAvatar>(html`<awc-avatar image="${image}" label="${label}"></awc-avatar>`);
    });
  ...
  describe('when provided initials parameter', () => {
    const initials = 'SL';
    before(async () => {
      el = await fixture<SlAvatar>(html`<awc-avatar initials="${initials}" label="Avatar"></awc-avatar>`);
    });
  ...
  ['square', 'rounded', 'circle'].forEach(shape => {
    describe(`when passed a shape attribute ${shape}`, () => {
      before(async () => {
        el = await fixture<SlAvatar>(html`<awc-avatar shape="${shape}" label="Shaped avatar"></awc-avatar>`);
      });
  ...
  describe('when passed a <span>, on slot "icon"', () => {
    before(async () => {
      el = await fixture<SlAvatar>(html`<awc-avatar label="Avatar"><span slot="icon">random content</span></awc-avatar>`);
    });
  ...
  it('should not render the image when the image fails to load', async () => {
    el = await fixture<SlAvatar>(html`<awc-avatar></awc-avatar>`);
    el.image = 'bad_image';
