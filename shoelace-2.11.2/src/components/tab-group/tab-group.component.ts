 ...
 */
export default class AWCTabGroup extends ShoelaceElement {
  ...
  private getAllPanels() {
    return [...this.body.assignedElements()].filter(el => el.tagName.toLowerCase() === 'awc-tab-panel') as [SlTabPanel];
  }
