 ...
 */
export default class AWCButton extends ShoelaceElement implements ShoelaceFormControl {
  ...
  render() {
    ...
    return html`
      ...
      >
        ...
        ${
          this.caret ? html` <awc-icon part="caret" class="button__caret" library="system" name="caret"></awc-icon> ` : ''
        }
