...
import AWCInput from '../input/input.component.js';
import AWCVisuallyHidden from '../visually-hidden/visually-hidden.component.js';
 ...
 */
export default class AWCColorPicker extends ShoelaceElement implements ShoelaceFormControl {
