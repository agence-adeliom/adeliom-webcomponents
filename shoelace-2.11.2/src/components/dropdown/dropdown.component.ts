 ...
 */
export default class AWCDropdown extends ShoelaceElement {
  ...
  //
  // AWCotted triggers can be arbitrary content, but we need to link them to the dropdown panel with `aria-haspopup` and
