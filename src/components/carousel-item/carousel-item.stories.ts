...
import type AWCCarouselItem from './carousel-item.js';
const { events, args, argTypes, template } = getWcStorybookHelpers<AWCCarouselItem>('awc-carousel-item');
...
} satisfies Meta<AWCCarouselItem>;
