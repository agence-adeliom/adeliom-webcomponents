...
export type BaseOEmbedProps<TOEmbedAttributes extends CoreOEmbedAttributes<TStyle>, TStyle> = Exclude<
  TOEmbedAttributes,
  'srcset' | 'style'
> &
  OEmbedSourceOptions;

type BaseOEmbedWithAspectRatioProps<TOEmbedAttributes extends CoreOEmbedAttributes<TStyle>, TStyle> = BaseOEmbedProps<
  TOEmbedAttributes,
  TStyle
> & {
  aspectRatio: number;
...
type OEmbedWithWidthAndHeightProps<TOEmbedAttributes extends CoreOEmbedAttributes<TStyle>, TStyle> = BaseOEmbedProps<
  TOEmbedAttributes,
  TStyle
> & {
  width: number;
...
type OEmbedWithSizeProps<TOEmbedAttributes extends CoreOEmbedAttributes<TStyle>, TStyle> =
...
export type FixedOEmbedProps<TOEmbedAttributes extends CoreOEmbedAttributes<TStyle>, TStyle> = Prettify<
...
export type FullWidthOEmbedProps<TOEmbedAttributes extends CoreOEmbedAttributes<TStyle>, TStyle> = BaseOEmbedProps<
  TOEmbedAttributes,
  TStyle
> & {
  layout: 'fullWidth';
 ...
 */
export const getStyle = <TOEmbedAttributes extends CoreOEmbedAttributes<TStyle>, TStyle = Record<string, string>>({
  width,
  height,
  aspectRatio,
  layout
...
>): TOEmbedAttributes['style'] => {
  ...
  return Object.fromEntries(styleEntries.filter(([, value]) => value)) as TOEmbedAttributes['style'];
};
...
>({
  ...
  const styleProps = {
    ...
    aspectRatio,
    layout
  } as Pick<AWCOEmbedProps<TOEmbedAttributes, TStyle>, 'width' | 'height' | 'aspectRatio' | 'layout'>;
