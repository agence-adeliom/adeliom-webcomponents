...
const { events, args, argTypes, template } = getWcStorybookHelpers<AWCFormatDate>('awc-format-date');
...
export const Primary: Story = {
  name: 'Default',
  render: () => html`<awc-format-date date="2020-07-15T09:17:00-04:00"></awc-format-date>`
};
