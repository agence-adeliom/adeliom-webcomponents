...
import type AWCMutationObserver from './mutation-observer';
const { events, args, argTypes, template } = getWcStorybookHelpers('awc-mutation-observer');
...
} satisfies Meta<AWCMutationObserver & typeof args>;
...
export const Primary: Story = {
  name: 'Example',
  render: () => html`<div class="mutation-overview">
...
export const ChildList: Story = {
  ...
  render: () => html`<div class="mutation-child-list">
