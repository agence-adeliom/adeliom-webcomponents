...
import type AWCMapTilelayerWMS from './map-tilelayer-wms.ts';
const { events, args, argTypes, template } = getWcStorybookHelpers('awc-map-tilelayer-wms');
...
} satisfies Meta<AWCMapTilelayerWMS & typeof args>;
export default meta;
