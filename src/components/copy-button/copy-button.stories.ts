...
export const Primary: Story = {
 ...
 export const CustomLabels: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Copy Buttons display feedback in a tooltip. You can customize the labels using the `copy-label`, `success-label`, and `error-label` attributes."
      }
    }
  }
};
...
export const ChangingFeedbackDuration: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "A success indicator is briefly shown after copying. You can customize the length of time the indicator is shown using the `feedback-duration` attribute."
      }
    }
  }
};
