...
import type AWCTooltip from '../tooltip/tooltip.js';

/**
 * @summary Copies text data to the clipboard when the user clicks the trigger.
 * @documentation https://awc.a-dev.cloud/components/copy
 * @status stable
 * @since 1.0
 *
 * @dependency awc-icon
...
export default class AWCCopyButton extends AWCElement {
  ...
  @query('awc-tooltip') tooltip: AWCTooltip;
