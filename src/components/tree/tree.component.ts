 ...
 * @documentation https://awc.a-dev.cloud/?path=/docs/components-tree--docs
 * @status stable
 * @since 1.0
 *
...
export default class AWCTree extends AWCElement {
  ...
  private handleTreeChanged = (mutations: MutationRecord[]) => {
    for (const mutation of mutations) {
      ...
      const removedNodes = [...mutation.removedNodes].filter(AWCTreeItem.isTreeItem) as AWCTreeItem[];
