...
import type AWCAnimation from './animations.ts';
...
export const Primary: Story = {
  name: "Example",
  render: () => html`<div class="animation-overview">
...
export const AnimationsEasings: Story = {
  ...
  render: () => html`<div class="animation-sandbox">
...
<style>
  ...
  parameters: {
    docs: {
      description: {
        story: 'This example demonstrates all of the baked-in animations and easings. Animations are based on those found in the popular [Animate.css](https://animate.style/) library.'
      },
    },
  }
};
...
export const IntersectionObserver: Story = {
  ...
  render: () => html`<div class="animation-scroll">
...
<style>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Use an [Intersection Observer](https://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API) to control the animation when an element enters or exits the viewport. For example, scroll the box below in and out of your screen. The animation stops when the box exits the viewport and restarts each time it enters the viewport.'
      },
    },
  },
};
...
export const CustomKeyframe: Story = {
  ...
  render:  () => html`<div class="animation-keyframes">
...
<style>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Supply your own [keyframe formats](https://developer.mozilla.org/en-US/docs/Web/API/Web_Animations_API/Keyframe_Formats) to build custom animations.'
      },
    },
  }
};
...
export const PlayingAnimationsDemand: Story = {
  ...
  render: () => html`<div class="animation-form">
...
<script>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Animations won\'t play until you apply the `play` attribute. You can omit it initially, then apply it on demand such as after a user interaction. In this example, the button will animate once every time the button is clicked.'
      },
    },
  }
}
