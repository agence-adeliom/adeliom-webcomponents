...
const { events, args, argTypes, template } = getWcStorybookHelpers<AWCCarousel>('awc-carousel');
...
export const FreeMode: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Set `free-mode` to `true` to enable free mode. See [free mode](https://swiperjs.com/free-mode` '
      }
    }
  }
};
