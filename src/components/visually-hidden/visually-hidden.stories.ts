...
export const Primary: Story = {
  name: 'Default',
  render: () => html`<div style="min-height: 1.875rem;">
  <awc-visually-hidden>
...
export const Links: Story = {
  ...
  render: () => html`<a href="https://example.com/" target="_blank">
  Visit External Page
  ...
  parameters: {
    docs: {
      description: {
        story: "In this example, the link will open a new window. Screen readers will announce \"opens in a new window\" even though the text content isn't visible to sighted users."
      }
    }
  }
};
...
export const Content: Story = {
  ...
  render: () => html`<awc-card style="width: 100%; max-width: 360px;">
  <header>
  ...
  parameters: {
    docs: {
      description: {
        story: "Adding a label may seem redundant at times, but they're very helpful for unsighted users. Rather than omit them, you can provide context to unsighted users with visually hidden content that will be announced by assistive devices such as screen readers."
      }
    }
  }
};
