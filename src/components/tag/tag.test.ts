...
describe('<awc-tag>', () => {
  it('should render default tag', async () => {
    const el = await fixture<AWCTag>(html` <awc-tag>Test</awc-tag> `);
  ...
  it('should set variant by attribute', async () => {
    const el = await fixture<AWCTag>(html` <awc-tag variant="danger">Test</awc-tag> `);
  ...
  it('should set size by attribute', async () => {
    const el = await fixture<AWCTag>(html` <awc-tag size="large">Test</awc-tag> `);
  ...
  it('should set pill-attribute by attribute', async () => {
    const el = await fixture<AWCTag>(html` <awc-tag pill>Test</awc-tag> `);
  ...
  it('should set removable by attribute', async () => {
    const el = await fixture<AWCTag>(html` <awc-tag removable>Test</awc-tag> `);
