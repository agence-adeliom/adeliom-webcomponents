    ...
    return html`
      ...
      >
        ...
        <span part="submenu-icon" class="menu-item__chevron">
          <awc-icon name=${isRtl ? 'chevron-left' : 'chevron-right'} library="system" aria-hidden="true"></awc-icon>
        </span>

        ${this.submenuController.renderSubmenu()}
        ${this.loading ? html` <awc-spinner part="spinner" exportparts="base:spinner__base"></awc-spinner> ` : ''}
      </div>
    `;
  }
}
