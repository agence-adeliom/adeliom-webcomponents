...
/**
 * @summary Radio groups are used to group multiple [radios](/docs/components-radio--docs) or [radio buttons](/docs/components-radio-button--docs) so they function as a single form control.
