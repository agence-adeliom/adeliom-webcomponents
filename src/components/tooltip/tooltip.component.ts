 ...
 * @documentation https://awc.a-dev.cloud/?path=/docs/components-tooltip--docs
 * @status stable
 * @since 1.0
 *
...
export default class AWCTooltip extends AWCElement {
  ...
  // aria-describedby attribute to a slot, which is required by <awc-popup> to correctly locate the first assigned
