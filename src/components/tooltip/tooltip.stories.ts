...
const { events, args, argTypes, template } = getWcStorybookHelpers<AWCTooltip>('awc-tooltip');
...
export const Placement: Story = {
  name: 'Placement',
  render: () =>
    html`<div class="tooltip-placement-example">
...
export const ManualTrigger: Story = {
  name: 'Manual Trigger',
  render: () =>
    html`<awc-button style="margin-right: 4rem;">Toggle Manually</awc-button>
...
export const RemovingArrows: Story = {
  ...
  render: () =>
    html`<awc-tooltip content="This is a tooltip" style="--awc-tooltip-arrow-size: 0;">
...
export const MaximumWidth: Story = {
  ...
  render: () =>
    html`<awc-tooltip style="--max-width: 80px;" content="This tooltip will wrap after only 80 pixels.">
