...
export default css`
  ...
  .button {
    ...
    padding: 0;
    transition:
      var(--awc-transition-x-fast) background-color,
      var(--awc-transition-x-fast) color,
      var(--awc-transition-x-fast) border,
      var(--awc-transition-x-fast) box-shadow;
    cursor: inherit;
  }
  ...
  .button--standard.button--warning:hover:not(.button--disabled) {
    background-color: var(--awc-color-warning-500);
    border-color: var(--awc-color-warning-500);
    color: var(--awc-color-neutral-0);
  }
