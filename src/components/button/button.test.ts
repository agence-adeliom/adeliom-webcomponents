...
describe('<awc-button>', () => {
  describe('accessibility tests', () => {
    variants.forEach(variant => {
      it(`should be accessible when variant is "${variant}"`, async () => {
        const el = await fixture<AWCButton>(html` <awc-button variant="${variant}"> Button Label </awc-button> `);
  ...
  describe('when provided no parameters', () => {
    it('passes accessibility test', async () => {
      const el = await fixture<AWCButton>(html` <awc-button>Button Label</awc-button> `);
      await expect(el).to.be.accessible();
    });
    ...
    it('should not have a spinner present', async () => {
      const el = await fixture<AWCButton>(html` <awc-button>Button Label</awc-button> `);
      expect(el.shadowRoot!.querySelector('awc-spinner')).not.to.exist;
    });
  ...
  describe('when disabled', () => {
    it('passes accessibility test', async () => {
      const el = await fixture<AWCButton>(html` <awc-button disabled>Button Label</awc-button> `);
      await expect(el).to.be.accessible();
    });
    ...
    it('should not disable the native <a> when rendering an <a>', async () => {
      const el = await fixture<AWCButton>(html` <awc-button href="some/path" disabled>Button Label</awc-button> `);
      expect(el.shadowRoot!.querySelector('a[disabled]')).not.to.exist;
    });

    it('should not bubble up clicks', async () => {
      const button = await fixture<AWCButton>(html` <awc-button disabled>Button Label</awc-button> `);
      ...
      const buttonLink = await fixture<AWCButton>(html`
        <awc-button href="some/path" disabled>Button Label</awc-button>
      `);
  ...
  it('should have title if title attribute is set', async () => {
    const el = await fixture<AWCButton>(html` <awc-button title="Test"></awc-button> `);
  ...
  describe('when loading', () => {
    it('should have a spinner present', async () => {
      const el = await fixture<AWCButton>(html` <awc-button loading>Button Label</awc-button> `);
      expect(el.shadowRoot!.querySelector('awc-spinner')).to.exist;
    });
  });

  describe('when caret', () => {
    it('should have a caret present', async () => {
      const el = await fixture<AWCButton>(html` <awc-button caret>Button Label</awc-button> `);
  ...
  describe('when href is present', () => {
    it('should render as an <a>', async () => {
      const el = await fixture<AWCButton>(html` <awc-button href="some/path">Button Label</awc-button> `);
    ...
    it('should render a link with rel="noreferrer noopener" when target is set and rel is not', async () => {
      const el = await fixture<AWCButton>(html`
        <awc-button href="https://example.com/" target="_blank">Link</awc-button>
      `);
    ...
    it('should render a link with rel="" when a target is provided and rel is empty', async () => {
      const el = await fixture<AWCButton>(html`
        <awc-button href="https://example.com/" target="_blank" rel="">Link</awc-button>
      `);
      const link = el.shadowRoot!.querySelector('a')!;
    ...
    it(`should render a link with a custom rel when a custom rel is provided`, async () => {
      const el = await fixture<AWCButton>(html`
        <awc-button href="https://example.com/" target="_blank" rel="1">Link</awc-button>
      `);
      const link = el.shadowRoot!.querySelector('a')!;
  ...
  describe('when submitting a form', () => {
    it('should submit when the button is inside the form', async () => {
      ...
      `);
      const button = form.querySelector<AWCButton>('awc-button')!;
    ...
    it('should submit when the button is outside the form and has a form attribute', async () => {
      const el = await fixture(html`
        <div>
          ...
          <awc-button type="submit" form="a">Submit</awc-button>
        </div>
      `);
      const form = el.querySelector<HTMLFormElement>('form')!;
      const button = el.querySelector<AWCButton>('awc-button')!;
      const handleSubmit = sinon.spy((event: SubmitEvent) => event.preventDefault());
    ...
    it('should override form attributes when formaction, formmethod, formnovalidate, and formtarget are used inside a form', async () => {
      const form = await fixture(html`
        <form id="a" action="foo" method="post" target="_self">
          <awc-button type="submit" form="a" formaction="bar" formmethod="get" formtarget="_blank" formnovalidate>
            Submit
          </awc-button>
        </form>
      `);
  ...
  describe('when using methods', () => {
    it('should emit awc-focus and awc-blur when the button is focused and blurred', async () => {
      const el = await fixture<AWCButton>(html` <awc-button>Button</awc-button> `);
    ...
    it('should emit a click event when calling click()', async () => {
      const el = await fixture<AWCButton>(html` <awc-button></awc-button> `);
