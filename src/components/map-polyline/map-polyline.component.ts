 ...
 * @documentation https://awc.a-dev.cloud/?path=/docs/components-map-vector-layers-polyline--docs
 * @status experimental
 * @since 1.0
 *
 *
...
export default class AWCMapPolyline extends LeafletPopupContentMixin(AWCLeafletElement) {
   ...
   */
  @property({ attribute: false }) feature: L.Polyline;
  ...
  containerChanged(): void {
    ...
    // forward events
    this.feature.on(AWCMapPolyline.events, this.onLeafletEvent);
  }
