...
import type AWCMapVideoOverlay from './map-video-overlay.ts';
const { events, args, argTypes, template } = getWcStorybookHelpers('awc-map-video-overlay');
...
} satisfies Meta<AWCMapVideoOverlay & typeof args>;
export default meta;
