 ...
 * @documentation https://awc.a-dev.cloud/?path=/docs/components-map-raster-layers-video-overlay--docs
 * @status experimental
 * @since 1.0
 *
 * @event load - Emitted when the VideoOverlay layer has loaded its video.
 * @event error - Emitted when the VideoOverlay layer fails to load its video.
