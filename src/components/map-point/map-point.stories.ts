...
import type AWCMapPoint from './map-point.ts';
const { events, args, argTypes, template } = getWcStorybookHelpers('awc-map-point');
...
} satisfies Meta<AWCMapPoint & typeof args>;
export default meta;
