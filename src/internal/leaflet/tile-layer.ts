...
export interface LeafletTileLayerMixinElement extends AWCLeafletElement {
  layer: L.TileLayer;
 ...
 */
export const LeafletTileLayerMixin = dedupeMixin(
  <TBase extends Constructor<AWCLeafletElement>>(
    superClass: TBase
  ): TBase & Constructor<LeafletTileLayerMixinElement> => {
