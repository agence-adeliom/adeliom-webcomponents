...
Next, [include a theme](/?path=/docs/getting-started-themes--docs). In this example, we'll import the light theme.
...
Next, set the [base path](/?path=/docs/getting-started-installation--docs#setting-the-base-path) for icons and other assets in the `main.ts`. In this example, we'll use the CDN as a base path.
...
> 📘 **Tip**
>
> Are you using Adeliom WebComponents with Angular? [Help us improve this page!](https://github.com/agence-adeliom/adeliom-webcomponents/blob/main/docs/frameworks/angular.md)
