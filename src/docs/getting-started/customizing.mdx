...
Many design tokens are described further along in this documentation. For a complete list, refer to `src/themes/light.css` in the project's [source code](https://github.com/agence-adeliom/adeliom-webcomponents/blob/main/src/themes/light.css).
