...
export const RequiredFields: StoryObj = {
    render: () => html`<form class="input-validation-required">
...
export const InputPatterns: StoryObj = {
    render: () => html`<form class="input-validation-pattern">
    ...
    <script type="module">
        ...
        await Promise.all([
            ...
            document.querySelector('.input-validation-pattern')
...
export const InputTypes: StoryObj = {
    render: () => html`<form class="input-validation-type">
    ...
    <script type="module">
        ...
        await Promise.all([
            ...
            document.querySelector('.input-validation-type')
                .addEventListener('submit', event => {
                    event.preventDefault();
                    alert('All fields are valid!');
                });
...
export const CustomErrorMessages: StoryObj = {
    render: () => html`<form class="input-validation-custom">
    ...
    <script type="module">
        ...
        await Promise.all([
            ...
            document.querySelector('.input-validation-custom')
                .addEventListener('submit', event => {
                    event.preventDefault();
                    alert('All fields are valid!');
                });
            document.querySelector('.input-validation-custom awc-input')
                .addEventListener('awc-input', () => {
                    if (input.value === 'awc') {
...
export const StylingInvalidFormControls: StoryObj = {
    render: () => html`<form class="validity-styles">
        <awc-input
                name="name"
                label="Name"
    ...
    <script type="module">
        ...
        await Promise.all([
            ...
            document.querySelector('.validity-styles')
                .addEventListener('submit', event => {
                    event.preventDefault();
                    alert('All fields are valid!');
                });
