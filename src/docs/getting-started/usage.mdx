...
If you are installing from the CDN, you can [download a local copy](https://cdn.jsdelivr.net/package/npm/@agence-adeliom/awc@%VERSION%/%NPMDIR%/web-types.json) and add it to the root of your project.
