...
function CustomEls({ URL }) {
  ...
  useLayoutEffect(() => {
    ...
    import('@agence-adeliom/awc').then(({ setBasePath }) => {
      setBasePath(`${URL}/static/static`);

      // This imports all components
      import('@agence-adeliom/awc/react');
      // If you're wanting to selectively import components, replace this line with your own definitions

      // import("@agence-adeliom/awc/components/button/button");
...
> 📘 **Tip**
>
> This will import all Adeliom WebComponents components for convenience. To selectively import components, refer to the [Using webpack](?path=/docs/getting-started-installation--docs#using-webpack) section of the docs.
