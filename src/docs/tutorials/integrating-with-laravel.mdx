...
> 📘 **Tip**
>
> This is a community-maintained document. Please [ask the community](/resources/community) if you have questions about this integration. You can also [suggest improvements](https://github.com/agence-adeliom/adeliom-webcomponents/blob/main/docs/tutorials/integrating-with-laravel.md) to make it better.
...
Import each Adeliom WebComponents component you plan to use in `/resources/js/bootstrap.js`. Use the full path to each component (as outlined in the [Cherry Picking instructions](https://webcomponents.adeliom.io/docs/getting-started-installation--docs#cherry-picking)). You can find the full import statement for a component in the _Importing_ section of the component's documentation (use the _Bundler_ import). Your imports should look similar to:

```js
import '@agence-adeliom/awc/components/button/button.js';
import '@agence-adeliom/awc/components/icon/icon.js';
import '@agence-adeliom/awc/components/dialog/dialog.js';
```
