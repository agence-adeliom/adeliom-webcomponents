    ...
    <div class="bg-neutral-100">
      <footer class="container mx-auto px-4 md:px-8 text-paragraph">
        <div class="mb-8 md:mb-5x-large grid gap-4 md:gap-12 pt-10 md:grid-cols-3 lg:grid-cols-5 lg:gap-8 lg:pt-12">
          ...
          <!-- nav - start -->
          <div>
            <awc-details class="footer-group">
              <div slot="summary" class="mb-2 font-semibold text-lg tracking-widest text-title">Products</div>
              <nav class="flex flex-col gap-4">
                <ul>
                  <li><awc-button href="#" variant="text">Overview</awc-button></li>
                  <li><awc-button href="#" variant="text">Solutions</awc-button></li>
                  <li><awc-button href="#" variant="text">Pricing</awc-button></li>
                  <li><awc-button href="#" variant="text">Customers</awc-button></li>
                </ul>
              </nav>
            </awc-details>
          </div>
          ...
          <div>
            <awc-details class="footer-group">
              <div slot="summary" class="mb-2 font-semibold text-lg tracking-widest text-title">Company</div>
              <nav class="flex flex-col gap-4">
                <ul>
                  <li><awc-button href="#" variant="text">About</awc-button></li>
                  <li><awc-button href="#" variant="text">Investor Relations</awc-button></li>
                  <li><awc-button href="#" variant="text">Jobs</awc-button></li>
                  <li><awc-button href="#" variant="text">Press</awc-button></li>
                  <li><awc-button href="#" variant="text">Blog</awc-button></li>
                </ul>
              </nav>
            </awc-details>
          </div>
          ...
          <div>
            <awc-details class="footer-group">
              <div slot="summary" class="mb-2 font-semibold text-lg tracking-widest text-title">Support</div>
              <nav class="flex flex-col gap-4">
                <ul>
                  <li><awc-button href="#" variant="text">Contact</awc-button></li>
                  <li><awc-button href="#" variant="text">Documentation</awc-button></li>
                  <li><awc-button href="#" variant="text">Chat</awc-button></li>
                  <li><awc-button href="#" variant="text">FAQ</awc-button></li>
                </ul>
              </nav>
            </awc-details>
          </div>
        ...
        <div
          class="border-t border-neutral-300 text-center md:text-left py-6 text-sm text-paragraph grid gap-2 md:grid-cols-3"
        >
          <div>© 2023 - Present Compagny. All rights reserved.</div>
          <div>
          ...
          <div class="md:text-right">Designed by AWC</div>
        </div>
      </footer>
    </div>
    <style>
      ...
      .footer-group::part(header),
      .footer-group::part(content) {
        padding: 0 0 0.5rem;
      }
      ...
      @media (min-width: 768px) {
        ...
        .footer-group::part(summary-icon) {
          display: none;
        }
      }
    </style>
    <script>
      (function () {
        const setFooterGroupState = () => {
          [...document.querySelectorAll('.footer-group')].map(details => {
            details.open = window.innerWidth > 768;
          });
        };
        window.onresize = setFooterGroupState;
        setFooterGroupState();
      })();
    </script>
  `
...
export const Footer3: StoryObj = {
  ...
  render: () => html`
    <footer>
      ...
      <div class="bg-neutral-100 text-paragraph">
        <div class="container mx-auto px-4 md:px-8">
          <div class="flex items-center justify-between gap-4 py-8">
            <span class="text-sm"> © 2023 - Present AWC. All rights reserved. </span>
            ...
            <div class="flex gap-2">
              ...
              <awc-icon-button name="linkedin" href="#" target="_blank" label="LinkedIn"></awc-icon-button>
              <awc-icon-button name="twitter" href="#" target="_blank" label="Twitter"></awc-icon-button>
            </div>
            <!-- social - end -->
          </div>
        </div>
...
export const Footer4: StoryObj = {
  name: 'Footer 4',
  render: () => html`
    <div class="bg-primary py-6 newsletter-banner">
      <div class="container mx-auto px-4 md:px-8">
        <div class="flex flex-col items-center justify-between gap-2 md:flex-row">
          <div class="mb-3 text-center md:mb-0 md:text-left">
            <span class="font-bold uppercase tracking-widest text-neutral-0">Newsletter</span>
            <p class="text-neutral-200">Subscribe to our newsletter</p>
          </div>

          <form class="flex w-full gap-2 md:max-w-md">
            <awc-input type="email" placeholder="Email" class="w-full flex-1"></awc-input>
            <awc-button variant="ghost" class="awc-theme-dark dark:awc-theme-light" outline>Sign up</awc-button>
          </form>
        </div>
      </div>
    </div>
...
export const Footer5: StoryObj = {
  ...
  render: () => html`
    <footer>
      <div class="container mx-auto px-4 md:px-8">
        <div class="flex flex-col items-center justify-between gap-2 border-b py-6 md:flex-row">
          <div class="mb-3 text-center md:mb-0 md:text-left">
            <span class="font-bold uppercase tracking-widest text-title">Newsletter</span>
            <p class="text-paragraph">Subscribe to our newsletter</p>
          </div>
        ...
        <div class="container mx-auto px-4 md:px-8">
          <div class="mb-8 md:mb-5x-large grid gap-4 md:gap-12 md:grid-cols-3 lg:grid-cols-5 lg:gap-8">
            <div class="col-span-full lg:col-span-2  mb-6">
              ...
              <p class="mb-6 text-paragraph sm:pr-8">
                Filler text is dummy text which has no meaning however looks very similar to real text
              </p>
...
export const Footer6: StoryObj = {
  name: 'Footer 6',
  render: () => html`
    <footer class="container mx-auto px-4 md:px-8 pt-4 sm:pt-10 lg:pt-12">
      <div class="flex flex-col items-center justify-between gap-4 border-t py-6 md:flex-row">
        <!-- nav - start -->
        <nav class="flex flex-wrap justify-center gap-x-4 gap-y-2 md:justify-start md:gap-6">
          <awc-button href="#" variant="text">Overview</awc-button>
          <awc-button href="#" variant="text">Solutions</awc-button>
          <awc-button href="#" variant="text">Pricing</awc-button>
          <awc-button href="#" variant="text">Customers</awc-button>
        </nav>
        <!-- nav - end -->
...
export const Footer7: StoryObj = {
  ...
  render: () => html`
    <footer class="container mx-auto px-4 md:px-8 pt-4 sm:pt-10 lg:pt-12">
      <div class="flex flex-col items-center border-t pt-6 mb-6">
        <!-- nav - start -->
      ...
      <div class="text-center py-6 text-sm text-paragraph grid gap-2">
        <div>© 2023 - Present Compagny. All rights reserved.</div>
        <div>
          <nav class="flex flex-row gap-4 justify-center">
            <a href="#">Legal notice</a>
      ...
      <div class="container mx-auto px-4 md:px-8">
        <div class="flex flex-col items-center justify-between gap-6 border-b py-6 md:flex-row">
          <div class="w-full flex flex-col sm:flex-row gap-6 sm:items-center sm:justify-between">
            <div>
              <span class="font-bold tracking-widest text-title">Sociis nibh aliquet tellus</span>
              <p class="text-paragraph">Elit mi tellus consectetur</p>
            </div>
          ...
          <div class="w-full flex flex-col sm:flex-row gap-6 sm:items-center sm:justify-between">
            <div>
              <span class="font-bold tracking-widest text-title">Venenatis sit pellentesque</span>
              <p class="text-paragraph">Elit mi tellus consectetur</p>
            </div>
