      ...
      <footer class="container mx-auto px-4 md:px-8">
        <div class="mb-16 grid grid-cols-2 gap-12 border-t pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
          <div class="col-span-full lg:col-span-2">
            ...
            <p class="mb-6 text-neutral-500 dark:text-neutral-200 sm:pr-8">
          ...
          <div>
            ...
            <nav class="flex flex-col gap-4">
              <div>
                <a
                  href="#"
                  class="text-neutral-500 dark:text-neutral-200 transition duration-100 hover:text-primary active:text-primary-600"
                  >Overview</a
                >
              </div>
        ...
        <div class="border-t py-8 text-center text-sm text-neutral-400">
          © 2023 - Present Compagny. All rights reserved.
        </div>
      </footer>
    </div>
  `
      ...
      <footer class="container mx-auto px-4 md:px-8">
        <div class="mb-16 grid grid-cols-2 gap-12 pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
          <div class="col-span-full lg:col-span-2">
            ...
            <p class="mb-6 text-neutral-400 sm:pr-8">
              Filler text is dummy text which has no meaning however looks very similar to real text.
            </p>
          ...
          <div>
            ...
            <nav class="flex flex-col gap-4">
              <div>
                <a href="#" class="text-neutral-400 transition duration-100 hover:text-primary active:text-primary-600"
                  >Overview</a
                >
              </div>
        ...
        <div class="border-t border-neutral-800 py-8 text-center text-sm text-neutral-400">
          © 2023 - Present Compagny. All rights reserved.
        </div>
      </footer>
    </div>
        ...
        <div class="container mx-auto px-4 md:px-8">
          <div class="grid grid-cols-2 gap-12 border-t pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
            <div class="col-span-full lg:col-span-2">
              ...
              <p class="text-neutral-500 dark:text-neutral-200 sm:pr-8">
                Filler text is dummy text which has no meaning however looks very similar to real text.
              </p>
            </div>
            ...
            <!-- nav - start -->
            <div>
              <div class="mb-4 font-bold uppercase tracking-widest text-neutral-800 dark:text-neutral-200">
                Products
              </div>
    ...
    <footer class="bg-white  dark:bg-neutral-950">
      ...
      <div class="pt-12 lg:pt-16">
        <div class="container mx-auto px-4 md:px-8">
          ...
          <div class="border-t py-8 text-center text-sm text-neutral-400">
            © 2021 - Present AWC. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
      ...
      <div class="container mx-auto px-4 md:px-8">
        <div class="flex flex-col items-center justify-between gap-2 border-b border-t py-6 md:flex-row">
          ...
          <form class="flex w-full gap-2 md:max-w-md">
            <input
              placeholder="Email"
              class="w-full flex-1 rounded border bg-neutral-50 px-3 py-2 text-neutral-800 dark:text-neutral-200 placeholder-neutral-500 outline-none ring-primary-300 transition duration-100 focus:ring"
            />
  ...
  render: () => html`
    <div class="bg-white  dark:bg-neutral-950 pt-4 sm:pt-10 lg:pt-12">
      <footer class="container mx-auto px-4 md:px-8">
        ...
        <div class="py-8 text-center text-sm text-neutral-400">© 2023 - Present Compagny. All rights reserved.</div>
      </footer>
    </div>
  `
};
