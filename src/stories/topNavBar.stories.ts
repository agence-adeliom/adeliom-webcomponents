    ...
    <div class="w-full border-b border-inputTextColor">
      ...
      >
        <a
          ...
          class="text-sm font-semibold text-paragraph transition duration-100 hover:text-primary active:text-primary-700 flex items-center gap-1"
        >
    ...
    <div class="w-full border-b border-inputTextColor">
      ...
      >
        <div class="flex items-center gap-1">
          ...
          <p class="text-paragraph font-semibold">paragraph</p>
        </div>
        <div class="flex items-center gap-1">
