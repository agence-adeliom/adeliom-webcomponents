  ...
  render: () => html`
    <div class="bg-white  dark:bg-neutral-950 py-6 sm:py-8 lg:py-12">
      <div class="container mx-auto px-4 md:px-8">
        <awc-typography class="mb-2 md:mb-3 text-center text-primary" noMargin
          ><strong class="font-semibold">Introducing</strong></awc-typography
        >
        <awc-typography type="h4" renderHas="h2" class="mb-4 text-center" noMargin
...
export const Heading2: StoryObj = {
  ...
  render: () => html`
    <div class="bg-white  dark:bg-neutral-950 py-6 sm:py-8 lg:py-12">
      <div class="container mx-auto px-4 md:px-8">
        <awc-typography class="mb-2 md:mb-3 text-primary" noMargin
          ><strong class="font-semibold">Introducing</strong></awc-typography
        >
        <awc-typography type="h4" renderHas="h2" class="mb-4" noMargin
          >Revolutionary way to build the web</awc-typography
        >
