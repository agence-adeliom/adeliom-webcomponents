...
export const Banner1: StoryObj = {
  name: 'Banner 1',
  render: () => html`<div class="bg-white dark:bg-neutral-950 pb-5">
    <!-- banner - start -->
    <div class="relative flex flex-wrap bg-primary-800 px-4 py-3 sm:flex-nowrap sm:items-center sm:justify-center sm:gap-3 sm:pr-8 md:px-8">
...
export const Banner2: StoryObj = {
  name: 'Banner 2',
  render: () => html`<div class="bg-white  dark:bg-neutral-950 py-5">
    <!-- banner - start -->
