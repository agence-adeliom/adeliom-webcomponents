...
export const Importing = ({ of }) => {
  ...
  return (
    <AWCTabGroup>
      <AWCTab slot="nav" panel="script">
        Script
      </AWCTab>
      <AWCTab slot="nav" panel="import">
        Import
      </AWCTab>
      <AWCTab slot="nav" panel="bundler">
        Bundler
      </AWCTab>
      <AWCTab slot="nav" panel="react">
        React
      </AWCTab>
      <AWCTabPanel name="script">
        <p>
          To import this component from{' '}
          <a href="https://www.jsdelivr.com/package/npm/@agence-adeliom/awc" target="_blank" rel="noreferrer noopener">
            the CDN
          </a>{' '}
          using a script tag:
        </p>
...
`}
      ...
      <AWCTabPanel name="bundler">
        <p>
          ...
          <a
            href="/?path=/docs/getting-started-installation--documentation#bundling"
            target="_blank"
...
`}
      ...
      <AWCTabPanel name="react">
        <p>
          ...
          <a href="/?path=/docs/framework-react--documentation" target="_blank" rel="noreferrer noopener">
            React component
          </a>
          :
        </p>
