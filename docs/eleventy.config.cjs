...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addNunjucksGlobal('CHANGELOG', () => {
    const CHANGELOG = fs.readFileSync(path.join('..', 'CHANGELOG.md'), { encoding: 'utf8', flag: 'r' });
    return awcFlavoredMarkdown.render(CHANGELOG);
  });
