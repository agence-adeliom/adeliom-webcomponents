...
:root {
  ...
  --awc-color-primary-default: var(--awc-color-purple-500);
...
```js
import { setDefaultAnimation } from '@agence-adeliom/awc/%NPMDIR%/utilities/animation-registry.js';
...
```js
import { setAnimation } from '@agence-adeliom/awc/%NPMDIR%/utilities/animation-registry.js';
