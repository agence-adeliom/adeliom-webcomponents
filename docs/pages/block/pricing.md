    ...
    <div class="mb-6 grid gap-6 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 lg:gap-8">
      ...
      <div class="relative flex flex-col rounded-lg border-2 border-indigo-500 p-4 pt-6">
        <div class="mb-12">
          <div class="absolute inset-x-0 -top-3 flex justify-center">
            <span class="flex h-6 items-center justify-center rounded-full bg-indigo-500 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-white">most popular</span>
          </div>
        ...
        <div class="mt-auto flex flex-col gap-8">
          ...
          <a href="#" class="block rounded-lg bg-indigo-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">Continue with Team</a>
        </div>
      </div>
      <!-- plan - end -->
      ...
      <div class="flex flex-col rounded-lg border p-4 pt-6">
        ...
        <div class="mt-auto flex flex-col gap-8">
          ...
          <a href="#" class="block rounded-lg bg-gray-800 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-gray-700 focus-visible:ring active:bg-gray-600 md:text-base">Contact Sales</a>
        </div>
      </div>
      <!-- plan - end -->
    </div>
...
<div class="bg-white py-6 sm:py-8 lg:py-12">
  <div class="mx-auto max-w-screen-lg px-4 md:px-8">
    ...
    <div class="mb-10 md:mb-16">
      <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Choose a Bundle</h2>
    ...
    <div class="flex flex-wrap items-center justify-center gap-4 sm:gap-0">
      ...
      <div class="w-full rounded-lg bg-gray-800 p-6 sm:w-1/2 sm:rounded-r-none sm:p-8 lg:w-1/3">
        ...
        <a href="#" class="block rounded-lg bg-gray-500 px-8 py-3 text-center text-sm font-semibold text-gray-100 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-600 focus-visible:ring active:text-gray-300 md:text-base">Get the Basic Bundle</a>
      </div>
      <!-- left side - end -->
      ...
      <div class="w-full rounded-lg bg-gradient-to-tr from-indigo-500 to-violet-400 p-6 shadow-xl sm:w-1/2 sm:p-8">
        ...
        <a href="#" class="block rounded-lg bg-indigo-200 bg-opacity-50 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-300 focus-visible:ring active:bg-indigo-400 md:text-base">Get the Pro Bundle</a>
      </div>
      <!-- right side - end -->
    </div>
  </div>
...
<div class="bg-white py-6 sm:py-8 lg:py-12">
  <div class="mx-auto max-w-screen-xl px-4 md:px-8">
    <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-8 lg:text-3xl xl:mb-12">Pick your plan</h2>
    ...
    <div class="mb-6 grid gap-x-6 gap-y-12 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 lg:gap-x-8">
      ...
      <div class="flex flex-col space-y-4">
        <div class="flex flex-col gap-4 rounded-lg border p-4 pt-6">
          ...
          <a href="#" class="block rounded-lg bg-gray-200 px-8 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base">Select Free</a>
        </div>
      ...
      <div class="flex flex-col space-y-4">
        <div class="relative flex flex-col gap-4 rounded-lg border border-indigo-500 p-4 pt-6">
          ...
          <a href="#" class="block rounded-lg bg-indigo-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">Select Team</a>
        </div>
      ...
      <div class="flex flex-col space-y-4">
        <div class="flex flex-col gap-4 rounded-lg border p-4 pt-6">
          ...
          <a href="#" class="block rounded-lg bg-gray-800 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-gray-700 focus-visible:ring active:bg-gray-600 md:text-base">Select Enterprise</a>
        </div>
