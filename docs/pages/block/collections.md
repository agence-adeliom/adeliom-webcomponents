...
<div class="bg-white py-6 sm:py-8 lg:py-12">
  <div class="container mx-auto px-4 md:px-8">
    ...
    <div class="grid gap-6 sm:grid-cols-2">
      <!-- product - start -->
      <awc-card class="card-image group rounded-lg overflow-hidden h-80 lg:h-96" inner shadow>
  ...
  <div class="container mx-auto px-4 md:px-8">
    ...
    <div class="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-3 xl:grid-cols-4">
      ...
      <awc-card class="card-collection group h-96 rounded-lg overflow-hidden" inner shadow>
        ...
        <div class="flex flex-col h-full justify-end">
          <div class="flex flex-col w-full p-2 mt-2 rounded-lg bg-white items-center">
            <span class="text-gray-500">Men</span>
            <a href="#" class="text-lg text-center font-bold text-gray-800 transition duration-100 hover:text-gray-500 lg:text-xl">Business Causual</a>
          </div>
        </div>
      </awc-card>
      <!-- product - end -->
      ...
      <awc-card class="card-collection group h-96 rounded-lg overflow-hidden" inner shadow>
        ...
        <div class="flex flex-col h-full justify-end">
          <div class="flex flex-col w-full p-2 mt-2 rounded-lg bg-white items-center">
            <span class="text-gray-500">Women</span>
            <a href="#" class="text-lg text-center font-bold text-gray-800 transition duration-100 hover:text-gray-500 lg:text-xl">Summer Season</a>
          </div>
        </div>
      </awc-card>
      <!-- product - end -->
      ...
      <awc-card class="card-collection group h-96 rounded-lg overflow-hidden" inner shadow>
        ...
        <div class="flex flex-col h-full justify-end">
          <div class="flex flex-col w-full p-2 mt-2 rounded-lg bg-white items-center">
            <span class="text-gray-500">Men</span>
            <a href="#" class="text-lg text-center font-bold text-gray-800 transition duration-100 hover:text-gray-500 lg:text-xl">Streetwear</a>
          </div>
        </div>
      </awc-card>
      <!-- product - end -->
      ...
      <awc-card class="card-collection group h-96 rounded-lg overflow-hidden" inner shadow>
        ...
        <div class="flex flex-col h-full justify-end">
          <div class="flex flex-col w-full p-2 mt-2 rounded-lg bg-white items-center">
            <span class="text-gray-500">Women</span>
            <a href="#" class="text-lg text-center font-bold text-gray-800 transition duration-100 hover:text-gray-500 lg:text-xl">Sale</a>
          </div>
        </div>
      </awc-card>
      <!-- product - end -->
