  ...
  <div class="container mx-auto px-4 md:px-8">
    ...
    <div class="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-8">
      ...
      <awc-card href="#" class="card-image" bordered shadow>
        ...
        <div class="flex flex-1 flex-col">
          <h2 class="mb-2 text-lg font-semibold">
            <a href="#" class="transition duration-100 hover:text-primary active:text-primary-600">New trends in Tech</a>
          </h2>

          <p class="mb-8">This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text.</p>
        </div>
      ...
      <awc-card href="#" class="card-image" bordered shadow>
        ...
        <div class="flex flex-1 flex-col">
          <h2 class="mb-2 text-lg font-semibold">
            <a href="#" class="transition duration-100 hover:text-primary active:text-primary-600">Working with legacy stacks</a>
          </h2>
      ...
      <awc-card href="#" class="card-image" bordered shadow>
        ...
        <div class="flex flex-1 flex-col">
          <h2 class="mb-2 text-lg font-semibold">
            <a href="#" class="transition duration-100 hover:text-primary active:text-primary-600">10 best smartphones for devs</a>
          </h2>
      ...
      <awc-card href="#" class="card-image" bordered shadow>
        ...
        <div class="flex flex-1 flex-col">
          <h2 class="mb-2 text-lg font-semibold">
            <a href="#" class="transition duration-100 hover:text-primary active:text-primary-600">8 High performance Notebooks</a>
          </h2>
    ...
    <div class="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-2 xl:grid-cols-2 xl:gap-8">
      ...
      <awc-card class="card-image group" horizontal bordered shadow>
        ...
        <div class="flex flex-col gap-2">
          ...
          <h2 class="text-xl font-bold">
            <a href="#" class="transition duration-100 group-hover:text-primary active:text-primary-600">New trends in Tech</a>
          </h2>
      ...
      <awc-card class="card-image group" horizontal bordered shadow>
        ...
        <div class="flex flex-col gap-2">
          ...
          <h2 class="text-xl font-bold">
            <a href="#" class="transition duration-100 group-hover:text-primary active:text-primary-600">Working with legacy stacks</a>
          </h2>
      ...
      <awc-card class="card-image group" horizontal bordered shadow>
        ...
        <div class="flex flex-col gap-2">
          ...
          <h2 class="text-xl font-bold">
            <a href="#" class="transition duration-100 group-hover:text-primary active:text-primary-600">10 best smartphones for devs</a>
          </h2>
      ...
      <awc-card class="card-image group" horizontal bordered shadow>
        ...
        <div class="flex flex-col gap-2">
          ...
          <h2 class="text-xl font-bold">
            <a href="#" class="transition duration-100 group-hover:text-primary active:text-primary-600">8 High performance Notebooks</a>
          </h2>
