  ...
  <div class="container mx-auto px-4 md:px-8">
    <div class="flex flex-col overflow-hidden rounded-lg bg-neutral-900 sm:flex-row md:h-80">
      ...
      <div class="flex w-full flex-col p-4 sm:w-1/2 sm:p-8 lg:w-2/5">
        ...
        <awc-typography class="mb-8 max-w-md text-neutral-400" noMargin >This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text.</awc-typography>
        <div class="mt-auto">
