  ...
  <div class="container mx-auto px-4 md:px-8">
    <div class="flex flex-col overflow-hidden rounded-lg bg-gray-900 sm:flex-row md:h-80">
      ...
      <div class="flex w-full flex-col p-4 sm:w-1/2 sm:p-8 lg:w-2/5">
        ...
        <awc-typography class="mb-8 max-w-md text-gray-400" noMargin >This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text.</awc-typography>
        <div class="mt-auto">
      ...
      <div class="order-first h-48 w-full bg-gray-700 sm:order-none sm:h-auto sm:w-1/2 lg:w-3/5">
        <awc-image
          ...
          width="1000"
          height="500"
          src="https://images.unsplash.com/photo-1505846951821-e25bacf2eccd?auto=format&q=75&fit=crop&crop=top" ></awc-image>
      </div>
      <!-- image - end -->
    </div>
  </div>
    ...
    <div class="flex flex-col overflow-hidden rounded-lg bg-gray-200 sm:flex-row md:h-80">
      ...
      <div class="order-first h-48 w-full bg-gray-300 sm:order-none sm:h-auto sm:w-1/2 lg:w-2/5">
        <awc-image
          ...
          aspectRatio="1"
          width="1000"
          src="https://images.unsplash.com/photo-1525547719571-a2d4ac8945e2?auto=format&q=75&fit=crop" ></awc-image>
      </div>
      <!-- image - end -->

      <!-- content - start -->
      <div class="flex w-full flex-col p-4 sm:w-1/2 sm:p-8 lg:w-3/5">
        <awc-typography type="h4" class="mb-4 text-gray-800" noMargin >Help center</awc-typography>
        <awc-typography class="mb-8 max-w-md text-gray-400" noMargin >This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text.</awc-typography>
  ...
  <div class="container mx-auto px-4 md:px-8">
    <div class="mx-auto flex max-w-xl flex-col items-center text-center">
      <awc-typography class="mb-4" noMargin >
        <p class="font-semibold text-indigo-500 md:mb-6 md:text-lg xl:text-xl">Proud to introduce</p>
      </awc-typography>
...
<div class="bg-white py-6 sm:py-8 lg:py-12">
  <div class="container mx-auto px-4 md:px-8">
    <div class="flex flex-col items-center justify-between gap-4 rounded-lg bg-gray-100 p-4 sm:flex-row md:p-8">
      <div>
        <awc-typography type="h5" class="text-indigo-500" noMargin >Start now</awc-typography>
        <awc-typography class="text-gray-600" noMargin >No Credit Card required</awc-typography>
      </div>
      <awc-button href="#" variant="primary" size="large">Start now</awc-button>
    </div>
  </div>
