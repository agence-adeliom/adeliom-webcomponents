    ...
    if (button?.classList.contains('code-preview__button--codepen')) {
      ...
      if (isReact) {
        ...
        jsTemplate =
          ...
          `import * as AWCPath from 'https://cdn.skypack.dev/@agence-adeliom/awc@${awcVersion}/${npmdir}/utilities/base-path';\n` +
          `\n` +
          `// Set the base path for Adeliom WebComponents assets\n` +
          `AWCPath.setBasePath('https://cdn.skypack.dev/@agence-adeliom/awc@${awcVersion}/${npmdir}/')\n` +
